...
public class GameBoard {
	...
	public void addCell(PropertyCell cell) {
        ...
        /*
         * it is not always OK to do this because some method call might have a different result.
         * to address this problem, the method call should be left separated and not be extracted
         * when the method is intended to generate different result (e.g. random number generator)
         * it should not be extracted, otherwise the same number will be used twice which is not the
